...
#define ENC_SSD_HEADS			1
#define ENC_SSD_CYLINDERS		1

#define ENC_SSD_SECTOR_TOTAL	(ENC_SSD_SECTORS*ENC_SSD_HEADS*ENC_SSD_CYLINDERS)
#define ENC_SSD_SIZE			(ENC_SSD_SECTOR_TOTAL << ENC_SSD_SECTOR_SHIFT)
